<?php
/**
 * 全生徒の grade_level を再計算して更新するページ（エラー表示付き）
 */
...
try {
    ...
    die("エラーが発生しました: " . $e->getMessage() . "<br>ファイル: " . $e->getFile() . " 行: " . $e->getLine());
}
?>
<!DOCTYPE html>
<html lang="ja">
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="info">
                <strong>✓ 完了</strong><br>
                <?php
                $changedCount = count(array_filter($results, function($r) { return $r['status'] === 'changed'; }));
                $unchangedCount = count(array_filter($results, function($r) { return $r['status'] === 'unchanged'; }));
                ...
                ?>
                更新完了: 変更 <?php echo $changedCount; ?>件 / 変更なし <?php echo $unchangedCount; ?>件 / 警告 <?php echo $warningCount; ?>件 / エラー <?php echo $errorCount; ?>件
            </div>
                    ...
                    <?php foreach ($results as $result): ?>
                        ...
                        <tr class="<?php echo $rowClass; ?>">
                            ...
                            <?php else: ?>
                                ...
                                <td><?php echo $result['status'] === 'changed' ? '✓ 変更' : '-'; ?></td>
                            <?php endif; ?>
                        </tr>
                    <?php endforeach; ?>
                </tbody>

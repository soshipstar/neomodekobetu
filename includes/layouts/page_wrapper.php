...
function getMenuConfig(): array
{
    ...
    return [
        ...
        'staff' => [
            ...
            ['page' => 'facility_evaluation', 'icon' => 'fact_check', 'label' => '事業所評価', 'url' => '/staff/facility_evaluation.php'],
        ...
        'guardian' => [
            ...
            ['page' => 'facility_evaluation', 'icon' => 'fact_check', 'label' => '事業所評価', 'url' => '/guardian/facility_evaluation.php'],

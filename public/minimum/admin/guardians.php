...
<div class="card" style="margin-bottom: var(--spacing-lg);">
    <div class="card-body">
        <h2 style="font-size: var(--text-headline); margin-bottom: var(--spacing-lg); color: var(--md-purple);">新規保護者登録</h2>
...
<div class="card">
    <div class="card-body">
        <h2 style="font-size: var(--text-headline); margin-bottom: var(--spacing-lg); color: var(--md-purple);">保護者一覧（<?= count($guardians) ?>名）</h2>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
    ...
    <div class="modal-content">
        ...
        <form action="guardians_save.php" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="padding: var(--spacing-md); background: var(--md-gray-6); border: 1px solid var(--md-gray-5); border-radius: var(--radius-sm); font-family: monospace;">

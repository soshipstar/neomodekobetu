...
if ($selectedStudentId && $selectedPeriodId) {
    ...
    if ($kakehashiData && $kakehashiData['is_hidden']) {
        header('Location: /minimum/guardian/kakehashi.php');
        exit;
    }
}
...
<?php else: ?>
    ...
    <?php if ($selectedPeriod): ?>
        ...
        <!-- かけはし入力フォーム -->
        <form method="POST" action="/minimum/guardian/kakehashi_save.php" id="kakehashiForm">
            ...
            <?php if ($kakehashiData): ?>
                <div class="button-group">
                    <a href="/minimum/guardian/kakehashi_pdf.php?student_id=<?= $selectedStudentId ?>&period_id=<?= $selectedPeriodId ?>" target="_blank" class="btn btn-info">
                        PDF印刷用ダウンロード
                    </a>
                </div>
            <?php endif; ?>
...
function changeStudent() {
    ...
    if (studentId) {
        window.location.href = '/minimum/guardian/kakehashi.php?student_id=' + studentId;
    }
}
...
function changePeriod() {
    ...
    if (studentId && periodId) {
        window.location.href = '/minimum/guardian/kakehashi.php?student_id=' + studentId + '&period_id=' + periodId;
    }
}

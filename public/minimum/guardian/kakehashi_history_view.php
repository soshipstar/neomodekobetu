...
if (!$studentId || !$periodId) {
    ...
    header('Location: /minimum/guardian/kakehashi_history.php');
    exit;
}
...
if ($type === 'staff') {
    if (!$staffData || !$staffData['is_submitted']) {
        ...
        header('Location: /minimum/guardian/kakehashi_history.php?student_id=' . $studentId);
        exit;
    }
...
<body>
    <div class="print-buttons no-print">
        ...
        <a href="/minimum/guardian/kakehashi_history.php?student_id=<?= $studentId ?>" class="print-button secondary">戻る</a>
    </div>
        ...
        <div class="content">
            ...
            <div class="section">
                <div class="section-header">
                    <div class="section-icon icon-wish"><span class="material-symbols-outlined" style="font-size: 18px; vertical-align: middle;">auto_awesome</span></div>

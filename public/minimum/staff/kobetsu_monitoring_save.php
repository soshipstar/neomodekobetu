...
if (!$planId || !$studentId || !$monitoringDate) {
    ...
    header("Location: /minimum/staff/kobetsu_monitoring.php?student_id=$studentId&plan_id=$planId" . ($monitoringId ? "&monitoring_id=$monitoringId" : ''));
    exit;
}
...
header("Location: /minimum/staff/kobetsu_monitoring.php?student_id=$studentId&plan_id=$planId&monitoring_id=$monitoringId");
exit;

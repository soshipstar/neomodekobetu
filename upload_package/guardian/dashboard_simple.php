...
<body>
    <div class="box">
        ...
        <p style="color: white;"><strong>保護者名:</strong> <?php echo htmlspecialchars($guardianName); ?></p>
        <p style="color: white;"><strong>ユーザーID:</strong> <?php echo htmlspecialchars($guardianId); ?></p>
    </div>

    <div class="box">
        <h2 style="color: white;">データベーステスト</h2>
        <?php
        try {
            $pdo = getDbConnection();
            ...
            echo "<p style='color: white;'><strong>紐づいている生徒数:</strong> {$studentCount}名</p>";

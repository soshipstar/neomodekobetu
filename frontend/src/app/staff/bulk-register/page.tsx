...
アセスメント,山田花子,山田太郎,2015-04-01,hanako@example.com,2025-04-01,0,1,1,1,1,1,0
アセスメントシンプル,山田花子,山田次郎,2017-06-15,,,0,1,0,1,0,1,0
アセスメント,鈴木美子,鈴木一郎,2016-08-15,yoshiko@example.com,2025-04-01,0,1,1,1,1,1,0`;
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                ...
                <tbody className="divide-y divide-[var(--neutral-stroke-3)]">
                  <tr><td className="px-3 py-2">教室名</td><td className="px-3 py-2"><Badge variant="warning">任意</Badge></td><td className="px-3 py-2">テキスト（省略時はログイン教室）</td><td className="px-3 py-2">アセスメント</td></tr>

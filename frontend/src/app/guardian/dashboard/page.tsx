    ...
    <div className="space-y-6">
      ...
      {hasAlerts && (
        <section>
          <h2 className="mb-3 flex items-center gap-2 text-lg font-semibold text-[var(--neutral-foreground-1)]">
            <MaterialIcon name="notifications" size={20} className="text-orange-500" />
            確認が必要な項目
          </h2>
          ...
          <div className="grid gap-3">
            ...
            {(pendingSupportPlans.length > 0 || signaturePendingPlans.length > 0) && (
              <AlertCard
                icon={<MaterialIcon name="assignment_turned_in" size={20} />}
                title="個別支援計画書"
      ...
      <section>
        <Card padding={false}>
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 border-t border-[var(--neutral-stroke-2)] px-4 py-3 text-xs text-[var(--neutral-foreground-3)] sm:px-6">
            ...
            <LegendItem>
              <MaterialIcon name="school" size={14} className="text-yellow-600" />
              学校休業日活動
            </LegendItem>
            <LegendItem>
            ...
            <LegendItem>
              <MaterialIcon name="refresh" size={14} className="text-[var(--brand-80)]" />
              振替活動日
            </LegendItem>
            <LegendItem>
              <MaterialIcon name="cancel" size={14} className="text-red-500" />
              欠席日
            </LegendItem>
            <LegendItem>
              ...
              return (
                <Card key={child.id}>
                  ...
                  <div className="mb-2 text-right">
                    ...
                    >
                      すべての連絡帳を見る <MaterialIcon name="arrow_forward" size={12} />
                    </Link>
                  </div>
      ...
      <section>
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <QuickLink href="/guardian/chat" label="チャット" icon="chat" />
...
function QuickLink({
  ...
  return (
    <Link href={href}>
      <Card className="flex items-center gap-3 transition-shadow hover:shadow-md p-3">
        <MaterialIcon name={icon} size={20} className="text-[var(--brand-80)]" />

  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          question: 'アセスメントの記入方法は？',
          answer: '【アセスメントの記入】\n\n1. メニューから「アセスメント（職員）」を開く\n2. 生徒を選択\n3. 提出期限を選択\n4. 各項目を入力（本人の願い、目標、五領域など）\n5. 「下書き保存」または「提出」\n\n※提出期限は個別支援計画の期間に連動しています',
          category: 'assessment',
        },
        {
          question: '保護者のアセスメントを確認するには？',
          answer: '【保護者アセスメントの確認】\n\n1. メニューから「アセスメント（保護者）」を開く\n2. 生徒を選択\n3. 提出期限を選択\n4. 保護者が入力した内容を確認\n\n※保護者が未入力の場合は「まだ作成されていません」と表示されます',
          category: 'assessment',
        },
      ],
    },
      ...
      items: [
        {
          ...
          answer: '【個別支援計画の作成】\n\n1. メニューから「個別支援計画」を開く\n2. 生徒を選択\n3. 「新規作成」または「AI生成」ボタン\n4. アセスメントの情報をもとに計画を入力\n5. 保存して完了\n\n※アセスメントを事前に記入しておくとスムーズです',
          category: 'plan',
        },
        {
          question: 'モニタリングとは？',

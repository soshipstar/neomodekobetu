...
const staffNav: NavItem[] = [
  ...
  { type: 'link', label: 'アセスメント（職員）', href: '/staff/kakehashi-staff', icon: 'handshake' },
  { type: 'link', label: 'アセスメント（保護者）', href: '/staff/kakehashi-guardian', icon: 'menu_book' },
...
const guardianNav: NavItem[] = [
  ...
  { type: 'link', label: 'アセスメント入力', href: '/guardian/kakehashi', icon: 'handshake' },
  { type: 'link', label: 'アセスメント履歴', href: '/guardian/kakehashi-history', icon: 'history' },

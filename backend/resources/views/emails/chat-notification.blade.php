                    ...
                    <tr>
                        <td style="padding: 32px 30px;">
                            ...
                            <p style="font-size: 15px; margin: 0 0 24px 0; color: #444444;">
                                <strong>{{ $senderName }}</strong> さんからチャットに新しいメッセージが届きました。
                            </p>

                            {{-- Message preview --}}
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="background-color: #f8f9fa; border-left: 4px solid #667eea; padding: 20px; border-radius: 0 8px 8px 0;">
                                        <p style="margin: 0 0 8px 0; font-weight: 600; color: #667eea; font-size: 14px;">
                                            {{ $senderName }}
                                        </p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 28px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $chatUrl }}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; padding: 14px 36px; border-radius: 25px; font-weight: 600; font-size: 15px; letter-spacing: 0.5px;">
                                            チャットを開く
                                        </a>
                                    </td>
                                </tr>
